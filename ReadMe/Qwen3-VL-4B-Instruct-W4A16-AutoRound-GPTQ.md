...
# Qwen3-VL-4B-Instruct-W4A16-AutoRound-GPTQ

## Model Overview
This is a **4-bit quantized** version of the powerful [Qwen/Qwen3-VL-4B-Instruct](https://huggingface.co/Qwen/Qwen3-VL-4B-Instruct) vision-language model.
...
model_id = "Vishva007/Qwen3-VL-4B-Instruct-W4A16-AutoRound-GPTQ"
